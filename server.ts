...
/**
 * Wrapper over the ngExpressEngine to console.log() the ExpressJS
 * result before returning it - `err` and `html`.
 */
export function customNgExpressEngine(
...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/test-ng142/browser');
